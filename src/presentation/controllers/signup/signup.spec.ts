...
describe('SignUp Controller', () => {
  ...
  it('should return 400 if no passowrd is provider', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  it('should return 400 if no passowrdConfirmation is provider', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  it('should return 400 if passowrdConfirmation fails', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  it('should return 500 if an AddAccount throws', () => {
    const { sut, addAccountStub } = makeSut()
